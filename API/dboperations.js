...
async function addClient(fName, lName, dob, phoneNumber, address, email, active, employeeID) {
    try {
        console.log("dob", dob);
        let pool = await sql.connect(config);
